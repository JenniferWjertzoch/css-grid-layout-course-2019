...
4. [Explicit And Implicit Grid](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#explicit-and-implicitgrid)
    * [Explicit](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#explicit)
    * [Implicit](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#implicit)
...
6. [Fractional Units fr](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#fractional-units)
    * [Combine fr with other CSS Units](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#combine-fr-with-other-css-units)
...
13. [Six Properties for Justification and Alignment](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#six-properties-for-justification-and-alignment)
    * [Justify-Content](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#justify-content)
    * [Align-Content](https://github.com/JenniferWjertzoch/CSS-Grid-Layout-Course-2019#align-content)
